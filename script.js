document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchLambCount() {
        try {
            const response = await fetch('https://https://eid-two-sopmous-projects.vercel.app/api/lamb-count');
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('https://eid-two-sopmous-projects.vercel.app/api/lamb-count', {
                method: 'POST',
                headers: {
